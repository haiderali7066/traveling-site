      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8">
            Pakistan's Top Tourism Destinations
          </h2>
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-white mb-4">
              Avail Discounted Tours{" "}
              <span className="text-orange-400">Up to 30% off</span>
            </p>
            <p className="text-gray-200 mb-8">
              Let's help in the amazing life experience of traveling to
              Pakistan. Hassle-free fully managed tours with an option to
              customization as per client needs, guided tours, safe and secure
              travel, best accommodations and quality food.
            </p>
